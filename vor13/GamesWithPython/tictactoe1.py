...
def playAgain():
    ...
    print('Do you want to play again? (yeas or no)')
...
def chooseRandomMoveFromList(board, moveList):
    ...
    # returnsnNone if there is no valid move.
    possibleMoves = []
    for i in moveList:
...
def getComputerMove(board, computerLetter):
    # Given a board and athe computer's letter, determine where to move and return that move.
    if computerLetter == 'X':
        playerLetter = 'O'
    else:
        playerLetter = 'X'
